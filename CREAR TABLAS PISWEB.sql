...
use master
go
IF NOT EXISTS(SELECT name FROM master.dbo.sysdatabases WHERE NAME = 'PISW_OPTICA_WEB')
CREATE DATABASE PISW_OPTICA_WEB
...
--(1) TABLA PERFIL
if not exists (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'PERFIL')
create table PERFIL(
...
if not exists (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'PRODUCTO_SUCURSAL')
create table PRODUCTO_SUCURSAL(
IdProductoSucursal int primary key identity(1,1),
